...
while True:
    ...
    if boxes[0]["x"] ==g["x"] and boxes[0]["y"] == g["y"] and boxes[1]["x"] ==g["x"] and boxes[1]["y"] ==g["y"]:
        print("Win")
        break
    ...
    # if next_px == boxes[0]["x"] and next_py == boxes[0]["y"] and (next_px+dx) == boxes[1]["x"] and (next_py+dy) == boxes[1]["y"]:
    ...
    #         print("box out of map!")
    #         continue
    #     elif (boxes[1]["x"] + dx) < 0  or (boxes[1]["x"] + dx) > 3:
    #         print("box out of map!")
    #         continue
    ...
    #         boxes[0]["y"] += dy
    #         continue
    # if next_px == boxes[1]["x"] and next_py == boxes[1]["y"] and (next_px + dx) == boxes[0]["x"] and (next_py + dy) == boxes[0]["y"]:
    #     if (boxes[0]["x"] + dx) < 0  or (boxes[0]["x"] + dx) > 3:
    #         print("box out of map!")
    #         continue
    #     elif (boxes[0]["y"] + dy) < 0  or (boxes[0]["y"] + dy) > 3:
    ...
    if next_px == boxes[0]["x"] and next_py == boxes[0]["y"]:
        if (boxes[0]["x"] + dx) < 0  or (boxes[0]["x"] + dx) > 3:
            ...
            boxes[0]["x"] += dx
            boxes[0]["y"] += dy
    if next_px == boxes[1]["x"] and next_py == boxes[1]["y"]:
